...
public class SpatialQuery extends BasicQuery {
    public static void main(String[] args) throws IOException {
        SpatialQuery stQuery = new SpatialQuery();
    ...
    public List<FilterBase> getFilters(String condition, TableConfig tableConfig) {
        ...
        SpatialFilter spatialFilter = new SpatialFilter(GeometryEngine.geometryToWkt(env, 0), tableConfig.getCompressType().toString());
